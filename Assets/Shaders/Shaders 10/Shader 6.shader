Shader "Custom/Bandera_LambertSpecAmbient"
{
    Properties
    {
        _MainTex("Bandera (Texture)", 2D) = "white" {}

        _AmbientColor("Ambient Light", Color) = (0.2, 0.2, 0.2, 1)
        _LightColor("Diffuse Light Color", Color) = (1, 1, 1, 1)
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                float3 diffuse = tex * _LightColor.rgb * NdotL;

                // Ambiental
                float3 ambient = tex * _AmbientColor.rgb;
